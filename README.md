...
02. Clone the repository:
    ...
    ```console
    git clone --recursive https://github.com/lesteve/prezto.git --branch mine "${ZDOTDIR:-$HOME}/.zprezto"
    ```
    ...
    <details>
      ...
      - Clone the repository:
        ...
        ```console
        git clone --recursive https://github.com/lesteve/prezto.git --branch mine "${ZDOTDIR:-${XDG_CONFIG_HOME:-$HOME/.config}/zsh}/.zprezto"
        ```
